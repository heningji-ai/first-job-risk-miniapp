...
.inline-purchase{margin-top:24rpx;border:1rpx solid #e1e6ff}.inline-unlock-button{margin-top:22rpx;background:#4057d6;color:#fff;font-size:30rpx;font-weight:700}.inline-unlock-button[disabled]{opacity:.72}.platform-copy{display:block;margin-top:12rpx;color:#7b8497;font-size:24rpx;text-align:center}.sticky-service-account-button{display:flex;align-items:center;justify-content:center;gap:8rpx;width:100%;margin-top:10rpx;padding:12rpx 18rpx;border:1rpx solid #d7dff4;border-radius:14rpx;background:#f5f7ff;color:#5267aa;font-size:24rpx;font-weight:600;line-height:1.4;box-sizing:border-box}.sticky-service-account-button::after{border:0}
