  ...
  <view class="page">
    ...
    <view v-else-if="pageState === 'ready'" class="content">
      ...
      <view v-if="showConversionArea" class="inline-purchase card">
        ...
        <button v-if="serviceAccountEntryPageState === 'free_result'" class="inline-service-account-button" @click="showServiceAccountQr">
...
.inline-purchase{margin-top:24rpx;border:1rpx solid #e1e6ff}.inline-unlock-button{margin-top:22rpx;background:#4057d6;color:#fff;font-size:30rpx;font-weight:700}.inline-unlock-button[disabled]{opacity:.72}.platform-copy{display:block;margin-top:12rpx;color:#7b8497;font-size:24rpx;text-align:center}.inline-service-account-button{display:flex;align-items:center;justify-content:center;gap:8rpx;width:100%;margin-top:14rpx;padding:16rpx 20rpx;border:1rpx solid #d7dff4;border-radius:16rpx;background:#f5f7ff;color:#5267aa;font-size:25rpx;font-weight:600;line-height:1.45;box-sizing:border-box}.inline-service-account-button::after{border:0}
